...
fn test_insertion_sort() {
    ...
    let mut a = [std::f64::consts::PI, 3.14, -6.18, 0., 42., -1., f64::INFINITY, -f64::INFINITY];
    insertion_sort(&mut a);
    assert_eq!(a, [-f64::INFINITY, -6.18, -1.0, 0.0, 3.14, std::f64::consts::PI, 42.0, f64::INFINITY]);

    let mut a = ["1", "3", "2", "4", "6", "5", "8", "7", "AZ", "9", "0", "12", "az"];
    insertion_sort(&mut a);
    assert_eq!(a, ["0", "1", "12", "2", "3", "4", "5", "6", "7", "8", "9", "AZ", "az"]);
}
